		...
		<div class="col-md-12">
			...
			if (!isset($event['id'])){
				...
				$enddate='';
                    ...
                    echo"</td></tr>";
                    if (isset($event['id'])){
                    $startdate=date("Y-m-d\TH:i:s", strtotime($event['startdatetime']));
                	}
                    echo"<tr><td>";
					echo form_label('Start date time:');
					echo "</td><td>";
                    $data_startdatetime = array(
                        'name' => 'startdatetime',
                        'id' => 'startdatetime',
                        'class'=>'input-group',
                        'type' => 'datetime-local',
                    ...
                    echo form_input($data_startdatetime);
                    echo "</td><td>";
                    echo form_error('startdatetime');
                    echo"</td></tr>";

                    if (isset($event['id'])){
                    $enddate=date("Y-m-d\TH:i:s", strtotime($event['enddatetime']));
                	}
					 echo"<tr><td>";
					echo form_label('End date time:');
					echo "</td><td>";
                    $data_enddatetime = array(
                        'name' => 'enddatetime',
                        'id' => 'enddatetime',
                        'class'=>'input-group',
                        'type' => 'datetime-local',
                    ...
                    echo form_input($data_enddatetime);
                    echo "</td><td>";
