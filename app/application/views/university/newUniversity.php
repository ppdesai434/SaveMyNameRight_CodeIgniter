		...
		<div class="col-md-12">
			...
			if (!isset($univ['id'])){
				...
				$univ['zip']='';
                    ...
                    echo form_open('university/newuniversity');
                    echo"<table class='table'>";
					echo form_hidden('id',$univ['id']);
                    echo"<tr><td>";
                    ...
                    $data_foundIn = array(
                        ...
                        'size'=>'10',
                        'class'=>'input-group',
                        'value'=>$univ['foundedIn']
                    );

                    echo form_input($data_foundIn);
                    echo "</td><td>";
                    echo form_error('foundedIn');
                    echo"</td></tr>";
