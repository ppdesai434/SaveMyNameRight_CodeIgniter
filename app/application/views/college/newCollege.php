		...
		<div class="col-md-12">
			...
			if (!isset($col['id'])){
				...
				$col['zip']='';
                    ...
                    echo form_open('college/newcollege');
                    echo"<table class='table'>";
					echo form_hidden('id',$col['id']);
                    echo"<tr><td>";
                    ...
                    echo"<tr><td>";
					echo form_label('University:');
					echo "</td><td colspan='2'>";
                    $data_univ = array();
                    $select_univ='';
                        foreach ($univ as $temp) {
						$data_univ[$temp['id']]=$temp['name'];
						if($temp['id']==$col['uid']){
							$select_univ=$temp['id'];
							}
                        }
                    
                    echo form_dropdown('university', $data_univ,$select_univ);
